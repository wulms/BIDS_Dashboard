...
metadata_df <- metadata_df %>% select(-PatientBirthDate, -PatientSex, -PatientWeight) 
...
```{r}
show_settings_external("T1w") %>% datatable_setting()
```
...
```{r}
show_settings_external("T2w") %>% datatable_setting()
```
...
```{r}
show_settings_external("T2star") %>% datatable_setting()
```

### T1map

```{r}
show_settings_external("T1map") %>% datatable_setting()
```

### T2map
```{r}
show_settings_external("T2map") %>% datatable_setting()
```


### FLAIR
```{r}
show_settings_external("FLAIR") %>% datatable_setting()
```


### PD
```{r}
show_settings_external("PD") %>% datatable_setting()
```


### PDT2
```{r}
show_settings_external("PDT2") %>% datatable_setting()
```


### inplaneT1
```{r}
show_settings_external("inplaneT1") %>% datatable_setting()
```


### inplaneT2
```{r}
show_settings_external("inplaneT2") %>% datatable_setting()
```


### Angio
```{r}
show_settings_external("angio") %>% datatable_setting()
```


### Defacemask
```{r}
show_settings_external("defacemask") %>% datatable_setting()
```


### SWI
```{r}
show_settings_external("swi") %>% datatable_setting()
```
...
### DWI
```{r}
show_settings_external("dwi") %>% datatable_setting()
```
...
```{r}
show_settings_external("bold") %>% datatable_setting()
```
